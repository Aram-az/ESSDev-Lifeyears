  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="max-w-6xl mx-auto space-y-12">
        {/* Page Title */}
        <PageTitle description="Design system components and usage examples for LifeYears Preventative Health Tracker">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card>
              <p className="text-gray-700">
                Simple card with body content only. This is the default card
                style.
              </p>
            </Card>
            ...
            >
              <p className="text-gray-700">
                This card includes a header section with a title. The header is
            ...
            >
              <p className="text-gray-700">
                This card includes a footer section with action buttons. The
                footer is separated by a border.
              </p>
            </Card>
            ...
            >
              ...
              <p className="text-sm text-gray-600">
                You can combine multiple components within cards to create rich,
