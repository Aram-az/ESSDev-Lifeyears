    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                  ...
                  <div key={item.id} className="card">
                    ...
                    <div className="mt-3 text-xs">
                      ...
                      <p className="text-gray-700 mt-1">
                        <span className="font-semibold">Effectiveness:</span> {item.effectiveness}
                      </p>
                    </div>
                  </div>
                ))}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {prevention.data.secondary.map((item) => (
                  <div key={item.id} className="card">
                    ...
                    <div className="mt-3 text-xs">
                      <p className="text-gray-700">
                        <span className="font-semibold">Target:</span> {item.targetCondition}
                      </p>
                      <p className="text-gray-700 mt-1">
                        <span className="font-semibold">Outcomes:</span> {item.outcomes}
                      </p>
                    </div>
                  </div>
                ))}
            ...
            <div>
              ...
              <div className="space-y-2">
                {longevity.data.riskFactors.map((factor) => (
                  <div key={factor.id} className="bg-red-50 border border-red-200 rounded p-3">
                    <div className="flex items-center justify-between">
                      <p className="font-semibold text-red-900">{factor.factor}</p>
            ...
            <div>
              ...
              <div className="space-y-2">
                {longevity.data.protectiveFactors.map((factor) => (
                  <div key={factor.id} className="bg-green-50 border border-green-200 rounded p-3">
                    <div className="flex items-center justify-between">
                      <p className="font-semibold text-green-900">{factor.factor}</p>
      ...
      <div className="bg-gray-50 rounded-lg p-6">
        ...
        <div className="space-y-2 text-sm font-mono">
          ...
          <div className="bg-white p-3 rounded border">
            <span className="text-green-600">GET</span> /api/prevention/secondary
          </div>
          <div className="bg-white p-3 rounded border">
